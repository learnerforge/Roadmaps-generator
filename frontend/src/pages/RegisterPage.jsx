      ...
      <div className="w-full max-w-sm animate-[fadeSlideUp_0.5s_ease-out]">
        <div className="rounded-xl border border-border bg-surface p-8 shadow-sm">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-text-2">Start your learning journey today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <label htmlFor="reg-name" className="mb-1.5 block text-xs font-semibold text-text-2">Full Name</label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border bg-bg-2 pl-10 pr-4 py-2.5 text-sm text-text placeholder:text-text-3 focus:outline-none transition-colors ${
                    fieldErrors.name ? 'border-red' : 'border-border focus:border-accent'
                  }`}
              ...
              {fieldErrors.name && <p id="reg-name-error" className="mt-1 text-[11px] text-red" role="alert">{fieldErrors.name}</p>}
            </div>
            <div>
              <label htmlFor="reg-email" className="mb-1.5 block text-xs font-semibold text-text-2">Email</label>
              <div className="relative">
                <svg className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {fieldErrors.email && <p id="reg-email-error" className="mt-1 text-[11px] text-red" role="alert">{fieldErrors.email}</p>}
            </div>
            <div>
              <label htmlFor="reg-password" className="mb-1.5 block text-xs font-semibold text-text-2">Password</label>
              <div className="relative">
                <svg className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-text-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {fieldErrors.password && <p id="reg-password-error" className="mt-1 text-[11px] text-red" role="alert">{fieldErrors.password}</p>}
            </div>
            <button
              type="submit"
              disabled={loading}
        ...
        <p className="mt-6 text-center text-xs text-text-3">
          ...
          <Link to="/login" className="font-semibold text-accent hover:text-accent-2 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
